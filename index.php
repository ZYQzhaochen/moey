...
<head>
	...
	<meta name="description" content="可能是最最最萌的一言网站～">
...
<body>
	...
	<section class="slide-bar">
		<ul>
			...
			<li><a href="pages/about.php" style="color: #FF69B4;" target="_top">关于萌言</a></li>
			<li><a href="pages/links.php" style="color: #FF69B4;" target="_top">友人帐(友链)</a></li>
			<li>API接口：</li>
			<li>&nbsp;• <a href="pages/yapi-help.php" style="color: #FF69B4;" target="_top">语句</a></li>
			<li>投稿：</li>
			<li>&nbsp;• <a href="pages/submit_y.php" style="color: #FF69B4;" target="_top">语句</a></li>
			<li>支持我们：</li>
			<li>&nbsp;• <a href="pages/thanks.php" style="color: #FF69B4;" target="_top">鸣谢</a></li>
			<li>&nbsp;• <a href="pages/donate.php" style="color: #FF69B4;" target="_top">赞赏</a></li>
			<li>More：</li>
			<li>&nbsp;• <a href="pages/open.php" style="color: #FF69B4;" target="_top">开源</a></li>
			<li>&nbsp;• <a href="pages/tiaokuan.html" style="color: #FF69B4;" target="_blank">使用条款</a></li>
		</ul>
	</section>
	<script>
