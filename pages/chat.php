...
$home_url = '../';
$page_prefix = '';
$page_title = '留言板 | 萌言Moey';
$page_heading = '留言板';
$page_keywords = '萌言,萌言网,moey,api,萌云网络,留言板';
$page_description = '有什么话想要告诉萌言？欢迎在这里留下自己的足记！';
$extra_head_html = '<style>
body {font-family:Arial, sans-serif;margin:0;padding:0;}
.container {max-width:900px;margin:0 auto;padding:10px;}
h1 {text-align:center;font-size:2rem;margin-bottom:14px;font-family:sq;}
form {display:flex;flex-direction:column;margin-bottom:12px;}
label {font-family:dk;display: block;margin-bottom:5px;cursor:url(\'../images/default.cur\'),default;}
input[type="text"], textarea {padding:10px;border:1px solid #ccc;border-radius:4px;margin-bottom:12px;font-size:15px;cursor:url(\'../images/text.cur\'),text;}
textarea {resize:vertical;min-height:100px;cursor:url(\'../images/text.cur\'),text;}
input[type="submit"] {background-color:#FF69B4;color:#fff;border:none;padding:10px;border-radius:4px;cursor:pointer;font-size:15px;}
input[type="submit"]:hover {background-color:#FF1493;cursor:url(\'../images/pointer.cur\'),pointer;}
select {display:block;width:100%;padding:5px;margin-bottom:10px;border:1px solid #ccc;border-radius:3px;cursor:url(\'../images/default.cur\'),default;}
.messages {list-style:none;margin:0;padding:0;}
input[type="email"], textarea {padding:10px;border:1px solid #ccc;border-radius:4px;margin-bottom:12px;font-size:15px;cursor:url(\'../images/text.cur\'),text;}
.message {border:1px dashed #FF69B4;border-radius:4px;padding:8px 10px;margin-bottom:14px;}
.message:hover {border:1px solid #FF69B4;}
.message__header {display:flex;justify-content:space-between;align-items:center;margin-bottom:6px;}
.message__author {font-weight:bold;font-family:sq;font-size:16px;}
.message__date {color:#777;font-family:sq;font-size:15px;}
.message__content {white-space:pre-wrap;font-family:sq;font-size:16px;line-height:1.6;}
    ...
    <div class="container">
        <div style="background:rgba(255,255,255,0.7); border: 2px dashed #C0C0C0; min-height: 50px; font-size: 16px; line-height: 1.5; margin: 5px; border-radius: 0.8em;padding: 10px;">
            ...
            <ul id="messages" class="messages">
                <?php
                // config.php 已由 init.php 加载，直接使用 $servername 等变量
