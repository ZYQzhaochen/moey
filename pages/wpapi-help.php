...
<head>
	...
	<title>二次元壁纸接口使用说明 | 萌言网Moey</title>
...
<body>
	<header class="header">
		...
		<h1 class="page-title">壁纸接口使用说明</h1>
	</header>
	<section class="wraper-page">
		<iframe src="wpapi-help-subpage.php" style="width:100%;height:100%;border:medium none;background:white"></iframe>
	</section>
