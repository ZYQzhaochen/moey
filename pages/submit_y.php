...
<body>
	...
	<header class="header">
		...
		<h1 class="page-title">语句投稿</h1>
	</header>
	<section class="wraper-page">
		<iframe src="submit_y-subpage.php" style="width:100%;height:100%;border:medium none;background:white"></iframe>
	</section>
